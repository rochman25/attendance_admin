    ...
    <div class="header-wrapper row m-0">
        ...
        <div class="left-header col horizontal-wrapper pl-0">
            <ul class="horizontal-menu">
                <li class="mega-menu outside"><a class="nav-link" href="#!"><i data-feather="layers"></i><span>Bonus
                            Ui</span></a>
                                ...
                                <div class="col mega-box">
                                    <div class="link-section">
                                        ...
                                        <ul>
                                            ...
                                            <li class="pl-0"><a href="email-header.html">Basic With Header</a>
                                            </li>
                                            <li class="pl-0"><a href="template-email.html">Ecomerce Template</a>
                                            </li>
                                            <li class="pl-0"><a href="template-email-2.html">Email Template
                                                    2</a></li>
                                            <li class="pl-0"><a href="ecommerce-templates.html">Ecommerce
                                                    Email</a></li>
                                            <li class="pl-0"><a href="email-order-success.html">Order
                                                    Success</a></li>
                                        </ul>
                                    </div>
                                </div>
            ...
            <ul class="nav-menus">
                ...
                <li class="cart-nav onhover-dropdown">
                    <div class="cart-box"><i data-feather="shopping-cart"></i><span
                            class="badge badge-pill badge-primary">2</span></div>
                    <ul class="cart-dropdown onhover-show-div">
                        <li>
                            <h6 class="mb-0 f-20">Shoping Bag</h6><i data-feather="shopping-cart"></i>
                        </li>
                        <li class="mt-0">
                            <div class="media"><img class="img-fluid rounded-circle mr-3 img-60"
                                    ...
                                    <div class="qty-box">
                                        <div class="input-group"><span class="input-group-prepend">
                                                <button class="btn quantity-left-minus" type="button" data-type="minus"
                                                    data-field=""><i data-feather="minus"></i></button></span>
                                            <input class="form-control input-number" type="text" name="quantity"
                                                ...
                                                <button class="btn quantity-right-plus" type="button" data-type="plus"
                                                    data-field=""><i data-feather="plus"></i></button></span>
                                        </div>
                                    </div>
                        ...
                        <li>
                            <div class="total">
                                <h6 class="mb-2 mt-0 text-muted">Order Total : <span class="f-right f-20">$598.00</span>
                                </h6>
                            </div>
                        </li>
                        <li><a class="btn btn-block btn-primary view-cart" href="cart.html">Go to shoping
                                bag</a><a class="btn btn-block btn-secondary view-cart"
