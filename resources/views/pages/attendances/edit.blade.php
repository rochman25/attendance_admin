                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input class="form-control @error('name') is-invalid @enderror" name="name"
                                                type="text" value="{{ old('name',$attendance->name) }}" required="">
                                            @error('name')
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="form-group m-t-15 m-checkbox-inline mb-0">
                                                @php($attendanceDays = explode(",",$attendance->days))
                                                @foreach ($days as $index => $item)
                                                    <div class="checkbox checkbox-dark">
                                                        <input id="inline-{{ $index }}" type="checkbox" name="days[]" value="{{ $item }}" @if(in_array($item, $attendanceDays)) checked @endif>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="form-group m-t-15 m-checkbox-inline mb-0 custom-radio-ml">
                                                <div class="radio radio-primary">
                                                    <input id="radioinline1" type="radio" name="status" value="1" @if($attendance->status == "1") checked @endif
                                                        required>
                                                    <label class="mb-0" for="radioinline1"><span class="digits">
                                                            Aktif</span></label>
                                                </div>
                                                <div class="radio radio-primary">
                                                    <input id="radioinline2" type="radio" name="status" value="0" @if($attendance->status == "0") checked @endif
                                                        required>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input class="form-control @error('check_in') is-invalid @enderror" name="check_in"
                                                type="time" value="{{ old('check_in',$attendance->check_in) }}" required="">
                                            @error('check_in')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input class="form-control @error('check_out') is-invalid @enderror" name="check_out"
                                                type="time" value="{{ old('check_out',$attendance->check_out) }}" required="">
                                            @error('check_out')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
