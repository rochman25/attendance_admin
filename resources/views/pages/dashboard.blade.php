                        ...
                        <div class="card bg-img">
                            ...
                            <div class="card-body">
                                <div class="body-bottom">
                                    <h6> 10% off For drama lights Couslations...</h6><span class="font-roboto">Lorem Ipsum
                                        is simply dummy...It is a long
                    ...
                    <div class="card-body pt-0">
                        <div class="media">
                            <div class="media-body">
                                ...
                                <h6>Updated Product<span class="dot-notification"></span></h6><span>Quisque
                        ...
                        <div class="chat">
                            <div class="media left-side-chat">
                                <div class="media-body d-flex">
                                    <div class="img-profile"> <img class="img-fluid" src="../assets/images/user.jpg"
                                            alt="Profile"></div>
                                    <div class="main-chat">
                                        <div class="message-main"><span class="mb-0">Hi deo, Please send me
                                                link.</span></div>
                                        <div class="sub-message message-main"><span class="mb-0">Right
                                                Now</span></div>
                                    </div>
                                </div>
                            ...
                            <div class="media right-side-chat">
                                ...
                                <div class="media-body text-right">
                                    <div class="message-main pull-right"><span class="mb-0 text-left">How
                                            can do for you</span>
                            ...
                            <div class="media left-side-chat">
                                <div class="media-body d-flex">
                                    <div class="img-profile"> <img class="img-fluid" src="../assets/images/user.jpg"
                                            alt="Profile"></div>
                                    <div class="main-chat">
                                        <div class="sub-message message-main mt-0"><span>It's argenty</span>
                                        </div>
                                    </div>
                                </div>
                                <p class="f-w-400">7:28 PM</p>
                            ...
                            <div class="media right-side-chat">
                                <div class="media-body text-right">
                                    <div class="message-main pull-right"><span class="loader-span mb-0 text-left"
